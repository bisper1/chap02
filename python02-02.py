...
multiline = "Life is to short\fYou need python"
print(multiline)
...
str = "기압골의 영향으로 28일은 충청도와 남부지방, 제주도에 비가 오겠고, 3월 2일에 전남, 경남, 제주도에 비가 시작되어 3일은 남부지방, 제주는 비, 강원영동은 비 또는 눈이 오겠습니다.<br />그 밖의 날에는 고기압의 영향으로 대체로 맑은 날이 많겠습니다.<br />기온은 평년(최저기온: -6~3℃, 최고기온: 6~12℃)보다 조금 높겠습니다.<br />강수량은 평년(1~3mm)보다 많겠으나, 중부지방(강원영동 제외)은 적겠습니다."
...
print("I ate {number} apples. so I was for {day} days".format(number = 10, day = 3))

# {index} 와 {변수이름} 을 동시에 혼용해서 사용이 가능함
print("I ate {0} apples. so I was for {day} days".format(10, day = 3))
